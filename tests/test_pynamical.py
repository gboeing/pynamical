...
def test_bifurcation_1():
    ...
    bifurcation_plot(pops, save=False, show=False)
    #plt.close()
...
def test_bifurcation_2():
    ...
    bifurcation_plot(pops, xmin=3.7, xmax=3.9, save=False, show=False)
    #plt.close()
...
def test_phase_diagram():
    ...
    phase_diagram(pops, xmin=0.25, xmax=0.75, ymin=0.8, ymax=1.01, size=7, color='viridis', save=False, show=False)
    #plt.close()

def test_phase_diagram_3d():
    pops = simulate(model=cubic_map, num_gens=200, rate_min=3.5, num_rates=30, num_discard=100)
    phase_diagram_3d(pops, xmin=-1, xmax=1, ymin=-1, ymax=1, zmin=-1, zmax=1, alpha=0.2, color='viridis', azim=330, save=False, show=False)
    #plt.close()

def test_cobweb_plot():
    cobweb_plot(r=3.9, save=False, show=False)
    #plt.close()
